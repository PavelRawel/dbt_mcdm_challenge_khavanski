...
- If you need to add any channel, you need to upload the data in the correct format. You can see [here](https://github.com/PavelRawel/dbt_mcdm_challenge_khavanski/blob/main/seeds/mcdm_paid_ads_basic_performance_structure.csv) AND add the data as .csv file to the seeds directory and run dbt seed
